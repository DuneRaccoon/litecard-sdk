...
T = TypeVar("T", bound="PassCountDetails")


@_attrs_define
class PassCountDetails:
    """Statistics for a single business related to pass counts.

    Attributes:
        id (str): The unique identifier for the business.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pass_count_details.additional_properties = d
        return pass_count_details
