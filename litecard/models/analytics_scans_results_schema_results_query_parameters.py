...
T = TypeVar("T", bound="AnalyticsScansResultsSchemaResultsQueryParameters")


@_attrs_define
class AnalyticsScansResultsSchemaResultsQueryParameters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        analytics_scans_results_schema_results_query_parameters = cls(
            start_date_time=start_date_time,
            end_date_time=end_date_time,
        )

        analytics_scans_results_schema_results_query_parameters.additional_properties = d
        return analytics_scans_results_schema_results_query_parameters
