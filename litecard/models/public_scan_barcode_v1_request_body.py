...
T = TypeVar("T", bound="PublicScanBarcodeV1RequestBody")


@_attrs_define
class PublicScanBarcodeV1RequestBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        public_scan_barcode_v1_request_body = cls(
            barcode_value=barcode_value,
            business_id=business_id,
        )

        public_scan_barcode_v1_request_body.additional_properties = d
        return public_scan_barcode_v1_request_body
