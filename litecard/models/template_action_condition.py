...
T = TypeVar("T", bound="TemplateActionCondition")


@_attrs_define
class TemplateActionCondition:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        template_action_condition.additional_properties = d
        return template_action_condition
