...
T = TypeVar("T", bound="PaymentAndSignUpResponseSchema")


@_attrs_define
class PaymentAndSignUpResponseSchema:
    """
    Attributes:
        card_id (Union[Unset, str]): Id of created card Example: abc123.
        checkout_url (Union[Unset, str]): URL to redirect to continue payment Example: https://checkout.url.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        payment_and_sign_up_response_schema = cls(
            card_id=card_id,
        ...
        payment_and_sign_up_response_schema.additional_properties = d
        return payment_and_sign_up_response_schema
