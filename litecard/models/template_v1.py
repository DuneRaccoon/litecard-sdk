...
from ..models.template_v1_status import TemplateV1Status
...
class TemplateV1:
    ...
    Attributes:
        ...
        version (float): Schema Version used by the template Default: 1.0.
        business_id (str): Identifies the owner of the record Example: R9xh12dga8i.
        status (TemplateV1Status): Template Status
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = TemplateV1Status(d.pop("status"))
        ...
        template_v1.additional_properties = d
        return template_v1
