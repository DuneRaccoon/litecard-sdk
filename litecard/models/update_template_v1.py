...
from ..models.base_template_v1_type import BaseTemplateV1Type
from ..models.update_template_v1_status import UpdateTemplateV1Status
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.base_template_v1_tiers import BaseTemplateV1Tiers
...
T = TypeVar("T", bound="UpdateTemplateV1")


@_attrs_define
class UpdateTemplateV1:
    """
    Attributes:
        id (str): Template ID Example: V1StGXR8_Z5jdHi6B-myT.
        name (Union[Unset, str]): Human readable name of the template Example: Bronze Card.
        ...
        description (Union[Unset, str]): Template Description Example: LiteCard Bronze Card.
        business_name (Union[Unset, str]): Name of the business Example: LiteCard.
        is_internal (Union[Unset, bool]): Public Visibility of the template/form
        type_ (Union[Unset, BaseTemplateV1Type]): The Type of Pass
        ...
        apple_wallet_settings (Union[Unset, TemplateAppleWalletSettingsV1]): Settings specific to apple wallet
        google_wallet_settings (Union[Unset, TemplateGoogleWalletSettingsV1]): Settings specific to google wallet
        ...
        tiers (Union[Unset, BaseTemplateV1Tiers]): Multi tiers Settings
        status (Union[Unset, UpdateTemplateV1Status]): Template Status
        update_existing_cards (Union[Unset, bool]): If true, will get all active cards and update them to match
    """
    ...
    type_: Union[Unset, BaseTemplateV1Type] = UNSET
    external_id: Union[Unset, str] = UNSET
    settings: Union[Unset, "SettingsV1"] = UNSET
    stripe_settings: Union[Unset, "StripeSettings"] = UNSET
    apple_wallet_settings: Union[Unset, "TemplateAppleWalletSettingsV1"] = UNSET
    google_wallet_settings: Union[Unset, "TemplateGoogleWalletSettingsV1"] = UNSET
    ...
    tiers: Union[Unset, "BaseTemplateV1Tiers"] = UNSET
    status: Union[Unset, UpdateTemplateV1Status] = UNSET
    update_existing_cards: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        apple_wallet_settings: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.apple_wallet_settings, Unset):
        ...
        update_existing_cards = self.update_existing_cards
        ...
        if apple_wallet_settings is not UNSET:
            field_dict["appleWalletSettings"] = apple_wallet_settings
        ...
        if update_existing_cards is not UNSET:
            field_dict["updateExistingCards"] = update_existing_cards
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Union[Unset, BaseTemplateV1Type]
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = BaseTemplateV1Type(_type_)
        ...
        _apple_wallet_settings = d.pop("appleWalletSettings", UNSET)
        apple_wallet_settings: Union[Unset, TemplateAppleWalletSettingsV1]
        if isinstance(_apple_wallet_settings, Unset):
            apple_wallet_settings = UNSET
        else:
            apple_wallet_settings = TemplateAppleWalletSettingsV1.from_dict(_apple_wallet_settings)

        _google_wallet_settings = d.pop("googleWalletSettings", UNSET)
        google_wallet_settings: Union[Unset, TemplateGoogleWalletSettingsV1]
        if isinstance(_google_wallet_settings, Unset):
            google_wallet_settings = UNSET
        else:
            google_wallet_settings = TemplateGoogleWalletSettingsV1.from_dict(_google_wallet_settings)
        ...
        tiers: Union[Unset, BaseTemplateV1Tiers]
        if isinstance(_tiers, Unset):
            tiers = UNSET
        else:
            tiers = BaseTemplateV1Tiers.from_dict(_tiers)

        _status = d.pop("status", UNSET)
        status: Union[Unset, UpdateTemplateV1Status]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = UpdateTemplateV1Status(_status)

        update_existing_cards = d.pop("updateExistingCards", UNSET)

        update_template_v1 = cls(
            id=id,
            name=name,
        ...
        update_template_v1.additional_properties = d
        return update_template_v1
