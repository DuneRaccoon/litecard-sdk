...
T = TypeVar("T", bound="ScanV1ResponseSchemaCardOwner")


@_attrs_define
class ScanV1ResponseSchemaCardOwner:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scan_v1_response_schema_card_owner = cls(
            id=id,
        ...
        scan_v1_response_schema_card_owner.additional_properties = d
        return scan_v1_response_schema_card_owner
