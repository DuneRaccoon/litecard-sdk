...
T = TypeVar("T", bound="ScanResponseSchemaActionsAdditionalProperty")


@_attrs_define
class ScanResponseSchemaActionsAdditionalProperty:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scan_response_schema_actions_additional_property = cls(
            condition=condition,
            action=action,
            label=label,
        )

        scan_response_schema_actions_additional_property.additional_properties = d
        return scan_response_schema_actions_additional_property
