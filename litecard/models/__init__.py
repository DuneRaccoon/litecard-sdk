...
class CardOwnerCopy(BaseModel):
    ...
    id: str = Field(description="Unique identifier for the card owner")
    business_id: str = Field(alias="businessId", description="Business identifier")
    name: str = Field(description="Full name of the card owner")
    membership_number: Optional[str] = Field(None, alias="membershipNumber", description="Membership number")
...
class Card(BaseModel):
    ...
    card_owner_copy: Optional[CardOwnerCopy] = Field(None, alias="cardOwnerCopy", description="Card owner copy")
