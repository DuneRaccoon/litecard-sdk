...
T = TypeVar("T", bound="PassCountDetailsForTemplate")


@_attrs_define
class PassCountDetailsForTemplate:
    """Statistics for a business or template related to pass counts.

    Attributes:
        downloaded_apple_pass_count (Union[Unset, int]): The count of Apple passes downloaded for this business.
        downloaded_google_pass_count (Union[Unset, int]): The count of Google passes downloaded for this business.
        ...
        downloads_count (Union[Unset, int]): The count of card downloads for this business.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pass_count_details_for_template = cls(
        ...
        pass_count_details_for_template.additional_properties = d
        return pass_count_details_for_template
