...
T = TypeVar("T", bound="ScanV1ResponseSchemaCardCardOwnerCopy")


@_attrs_define
class ScanV1ResponseSchemaCardCardOwnerCopy:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scan_v1_response_schema_card_card_owner_copy = cls(
            id=id,
        ...
        scan_v1_response_schema_card_card_owner_copy.additional_properties = d
        return scan_v1_response_schema_card_card_owner_copy
