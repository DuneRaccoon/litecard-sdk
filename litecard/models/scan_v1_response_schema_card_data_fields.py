...
T = TypeVar("T", bound="ScanV1ResponseSchemaCardDataFields")


@_attrs_define
class ScanV1ResponseSchemaCardDataFields:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scan_v1_response_schema_card_data_fields = cls(
            example_data_field=example_data_field,
            full_name=full_name,
        )

        scan_v1_response_schema_card_data_fields.additional_properties = d
        return scan_v1_response_schema_card_data_fields
