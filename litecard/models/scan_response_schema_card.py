...
from ..models.scan_response_schema_card_status import ScanResponseSchemaCardStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.scan_response_schema_card_data_fields import ScanResponseSchemaCardDataFields


T = TypeVar("T", bound="ScanResponseSchemaCard")


@_attrs_define
class ScanResponseSchemaCard:
    """
    Attributes:
        ...
        google_link (Union[Unset, str]): Url of google pass Example: https://pay.google.com/gp/v/save/eyJhbGciOiJSUzI1Ni
            IsInR5cCI6IkpXVCJ9.
            DAiXX0.bR5nSNqMPH6KUwiaqMP-E-
        ...
        data_fields (Union[Unset, ScanResponseSchemaCardDataFields]):
        ...
        status (Union[Unset, ScanResponseSchemaCardStatus]): Activation Status of the card Example: INACTIVE.
    ...
    data_fields: Union[Unset, "ScanResponseSchemaCardDataFields"] = UNSET
    ...
    status: Union[Unset, ScanResponseSchemaCardStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data_fields, Unset):
            ...
            data_fields = ScanResponseSchemaCardDataFields.from_dict(_data_fields)
        ...
        status: Union[Unset, ScanResponseSchemaCardStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = ScanResponseSchemaCardStatus(_status)
        ...
        scan_response_schema_card.additional_properties = d
        return scan_response_schema_card
