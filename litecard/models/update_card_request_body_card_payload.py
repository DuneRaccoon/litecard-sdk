...
T = TypeVar("T", bound="UpdateCardRequestBodyCardPayload")


@_attrs_define
class UpdateCardRequestBodyCardPayload:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_card_request_body_card_payload = cls(
            example_property=example_property,
        )

        update_card_request_body_card_payload.additional_properties = d
        return update_card_request_body_card_payload
