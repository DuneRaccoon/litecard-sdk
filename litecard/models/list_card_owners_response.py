...
T = TypeVar("T", bound="ListCardOwnersResponse")


@_attrs_define
class ListCardOwnersResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_card_owners_response.additional_properties = d
        return list_card_owners_response
