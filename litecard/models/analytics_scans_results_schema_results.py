...
if TYPE_CHECKING:
    from ..models.aggregated_scans_statistics import AggregatedScansStatistics
    from ..models.analytics_scans_results_schema_results_query_parameters import (
        AnalyticsScansResultsSchemaResultsQueryParameters,
    )


T = TypeVar("T", bound="AnalyticsScansResultsSchemaResults")


@_attrs_define
class AnalyticsScansResultsSchemaResults:
    """
    Attributes:
        business_id (Union[Unset, str]):  Example: litecard.
        query_parameters (Union[Unset, AnalyticsScansResultsSchemaResultsQueryParameters]):
        num_results (Union[Unset, float]):  Example: 8.
        analytics (Union[Unset, list['AggregatedScansStatistics']]):
    """

    business_id: Union[Unset, str] = UNSET
    query_parameters: Union[Unset, "AnalyticsScansResultsSchemaResultsQueryParameters"] = UNSET
    num_results: Union[Unset, float] = UNSET
    analytics: Union[Unset, list["AggregatedScansStatistics"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_query_parameters, Unset):
            ...
            query_parameters = AnalyticsScansResultsSchemaResultsQueryParameters.from_dict(_query_parameters)
        ...
        for analytics_item_data in _analytics or []:
            analytics_item = AggregatedScansStatistics.from_dict(analytics_item_data)

            analytics.append(analytics_item)

        analytics_scans_results_schema_results = cls(
        ...
        analytics_scans_results_schema_results.additional_properties = d
        return analytics_scans_results_schema_results
