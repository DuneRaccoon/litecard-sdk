...
from ..models.scan_v1_response_schema_card_status import ScanV1ResponseSchemaCardStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.scan_v1_response_schema_card_card_owner_copy import ScanV1ResponseSchemaCardCardOwnerCopy
    from ..models.scan_v1_response_schema_card_data_fields import ScanV1ResponseSchemaCardDataFields


T = TypeVar("T", bound="ScanV1ResponseSchemaCard")


@_attrs_define
class ScanV1ResponseSchemaCard:
    """
    Attributes:
        ...
        data_fields (Union[Unset, ScanV1ResponseSchemaCardDataFields]):
        ...
        status (Union[Unset, ScanV1ResponseSchemaCardStatus]): Activation Status of the card Example: INACTIVE.
        ...
        card_owner_copy (Union[Unset, ScanV1ResponseSchemaCardCardOwnerCopy]): A copy of the card owner's information
    ...
    data_fields: Union[Unset, "ScanV1ResponseSchemaCardDataFields"] = UNSET
    ...
    status: Union[Unset, ScanV1ResponseSchemaCardStatus] = UNSET
    expiry: Union[Unset, str] = UNSET
    barcode_link: Union[Unset, str] = UNSET
    card_owner_copy: Union[Unset, "ScanV1ResponseSchemaCardCardOwnerCopy"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data_fields, Unset):
            ...
            data_fields = ScanV1ResponseSchemaCardDataFields.from_dict(_data_fields)
        ...
        status: Union[Unset, ScanV1ResponseSchemaCardStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = ScanV1ResponseSchemaCardStatus(_status)
        ...
        card_owner_copy: Union[Unset, ScanV1ResponseSchemaCardCardOwnerCopy]
        if isinstance(_card_owner_copy, Unset):
            card_owner_copy = UNSET
        else:
            card_owner_copy = ScanV1ResponseSchemaCardCardOwnerCopy.from_dict(_card_owner_copy)
        ...
        scan_v1_response_schema_card = cls(
        ...
        scan_v1_response_schema_card.additional_properties = d
        return scan_v1_response_schema_card
