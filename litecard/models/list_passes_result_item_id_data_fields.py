...
T = TypeVar("T", bound="ListPassesResultItemIdDataFields")


@_attrs_define
class ListPassesResultItemIdDataFields:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_passes_result_item_id_data_fields = cls(
        ...
        list_passes_result_item_id_data_fields.additional_properties = d
        return list_passes_result_item_id_data_fields
