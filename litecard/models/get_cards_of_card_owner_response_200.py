...
T = TypeVar("T", bound="GetCardsOfCardOwnerResponse200")


@_attrs_define
class GetCardsOfCardOwnerResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_cards_of_card_owner_response_200 = cls(
            results=results,
            next_=next_,
        )

        get_cards_of_card_owner_response_200.additional_properties = d
        return get_cards_of_card_owner_response_200
