...
T = TypeVar("T", bound="ListFormsResultItemIdStyle")


@_attrs_define
class ListFormsResultItemIdStyle:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_forms_result_item_id_style = cls(
        ...
        list_forms_result_item_id_style.additional_properties = d
        return list_forms_result_item_id_style
